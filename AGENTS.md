...
- Shared product brain: `docs/plan/PROJECT_BRAIN.md`
- Milestone briefs: `docs/plan/milestones/`
- Read `PROJECT_BRAIN.md` when starting a new phase or when product intent is unclear.
- For implementation, read only the active milestone brief plus this conventions file.
- Keep milestone files updated when scope decisions change.
